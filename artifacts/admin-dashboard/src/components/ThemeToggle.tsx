    ...
    <div ref={ref} className="relative">
      <div className="flex items-center gap-1.5">
        ...
        >
          ...
          {!compact && (
            <span className="text-[10px] font-bold hidden sm:block" style={{ color: isDark ? "rgba(255,255,255,0.60)" : "rgba(11,33,71,0.55)" }}>
              Theme
            </span>
          )}
        </button>
      ...
      {open && (
        <div
          className="absolute top-full mt-2 right-0 z-[999] w-56 rounded-2xl overflow-hidden"
          style={{
            background: "#ffffff",
        ...
        >
          ...
          <div className="px-4 pt-3.5 pb-2">
            <p className="text-[9px] font-black uppercase tracking-widest" style={{ color: "rgba(11,33,71,0.40)" }}>
              Display Mode
            </p>
          </div>
